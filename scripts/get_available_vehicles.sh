...
function get_new_token() {
	local RESPONSE=$(curl -sXPOST https://java-us01.vulog.com/auth/realms/BCAA-CAYVR/protocol/openid-connect/token/ -H "Content-Type: application/x-www-form-urlencoded; charset=utf-8" -H "User-Agent: okhttp/3.12.8" --data "scope=&client_id=BCAA-CAYVR_anon&client_secret=dbe490f4-2f4a-4bef-8c0b-52c0ecedb6c8&grant_type=client_credentials");
...
MODELS=$(curl -s https://java-us01.vulog.com/apiv5/models -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc");
...
curl -s https://java-us01.vulog.com/apiv5/options -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc";
...
PARKING=$(curl -s https://java-us01.vulog.com/apiv5/mapping/layers -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc");
...
HOMEZONES=$(curl -s https://java-us01.vulog.com/apiv5/mapping/homezones -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc");
...
CITIES=$(curl -s https://java-us01.vulog.com/apiv5/cities -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc");
...
VEHICLES=$(curl -s https://java-us01.vulog.com/apiv5/availableVehicles/fc256982-77d1-455c-8ab0-7862c170db6a -H "Authorization: $TOKENTYPE $ACCESSTOKEN" -H "X-API-Key: f52e5e56-c7db-4af0-acf5-0d8b13ac4bfc" -H "user-lat: 49.279844999999995" -H "user-lon: -123.10200666666667");
